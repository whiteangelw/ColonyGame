...
public sealed class TaskSelectionService
{
        ...
        Predicate<Task> isTaskTemporarilyDeferred = null)
    {
        ...
        for (int i = 0; i < candidateBuffer.Count; i++)
        {
            ...
            // Uma entrega para máquina também é HaulResource e não possui
            // blueprint. Somente tarefas com item físico como alvo devem
            // exigir alcance exato do tile do item.
