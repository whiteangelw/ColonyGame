...
public class BlueprintManager : Singleton<BlueprintManager>
{
    ...
    public bool CancelBlueprintAt(Vector2Int position)
    {
        ...
        foreach (ConstructionBlueprint blueprint in activeBlueprints.ToArray())
        {
            ...
            {
                activeBlueprints.Remove(blueprint);
                TaskManager.Instance?.CancelTasksForBlueprint(blueprint);
    ...
    {
        return CreateBlueprint(gridPos, string.Empty, buildTile, layer);
    }

    public ConstructionBlueprint CreateBlueprint(
        Vector2Int gridPos,
        string definitionId,
        TileType buildTile,
        GridLayer layer = GridLayer.Terrain)
    {
        ...
        float workTime = definition != null ? definition.WorkTime : 3f;
    ...
    public ConstructionBlueprint RestoreBlueprint(
        ...
        float currentWorkDone, GridLayer layer, string definitionId = "")
    {
