...
public static class TaskNavigationUtility
{
    ...
    public static bool EnableBuildTileDiagnostics = true;
    ...
    public static List<Vector2Int> GetPathToTask(Vector2Int startPos, Task task, DuplicantCapabilityProfile profile = null)
    {
        ...
        // Somente coleta de um item físico exige chegar exatamente ao tile.
        // Entregas para blueprints e máquinas usam posições de interação
        // ao redor do destino.
                ...
                candidatePositions))
        {
            ...
            List<Vector2Int> footprintPath =
                FindPathToClosestReachableCandidate(
                    startPos,
                    effectiveProfile);
            ...
            // As células imediatamente ao redor do footprint podem estar
            // ocupadas por outros blueprints ou sem apoio. Nesse caso,
            // continua abaixo e procura uma posição dentro do alcance de
            // trabalho do duplicant.
            candidatePositions.Clear();
        }
        ...
        DuplicantCapabilityProfile profile = null)
    {
                ...
                candidatePositions))
        {
            ...
            // Não encerra a busca quando o perímetro imediato da estrutura
            // não está alcançável. Ainda pode existir uma posição válida
            // dentro do alcance de interação do duplicant.
            candidatePositions.Clear();
        }
