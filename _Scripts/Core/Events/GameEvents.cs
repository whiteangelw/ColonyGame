...
public static class GameEvents
{
    ...
    public static event Action<string, TileType, GridLayer>
        OnBuildDefinitionSelected;
    public static void TriggerBuildDefinitionSelected(
        string definitionId,
        TileType tileType,
        GridLayer layer)
        => OnBuildDefinitionSelected?.Invoke(definitionId, tileType, layer);
    ...
    public static event Action<string> OnBuildDefinitionUnlocked;
    public static void TriggerBuildDefinitionUnlocked(string definitionId)
        => OnBuildDefinitionUnlocked?.Invoke(definitionId);

    public static event Action OnRecipeUnlockStateChanged;
    public static void TriggerRecipeUnlockStateChanged()
        => OnRecipeUnlockStateChanged?.Invoke();
