...
public class DuplicantController : MonoBehaviour
{
    ...
    private void CheckAndRescueIfTrapped(Vector2Int visualGridPosition)
    {
        ...
        if (!GridManager.Instance.IsTerrainOccupiable(visualGridPosition))
        {
            Vector2Int safeTile =
            ...
            RecoverTo(
                safeTile,
                TaskInterruptionOrigin.RescueTerrainCollision);
        }
    }
            ...
            TaskInterruptionOrigin.RescueTerrainCollision)
    {
        ...
        CancelCurrentTaskExecution(origin);
    ...
    public void CancelCurrentTaskExecution(bool preserveCarriedInventory = false)
    {
        ...
        bool preserveCarriedInventory = false)
    {
        ...
        TaskRunner?.CancelActiveTaskState(origin, preserveCarriedInventory);
